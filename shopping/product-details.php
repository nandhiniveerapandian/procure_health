...
<html lang="en">
    ...
    <body class="cnt-home" style="background-color: #fbea8c;">
		...
		<div class='row single-product outer-bottom-sm '>
			<div class='col-md-3 sidebar'>
				<div class="sidebar-module-container">
					...
					<!-- ==============================================CATEGORY============================================== -->
<div class="sidebar-widget outer-bottom-xs wow fadeInUp"  style="background-color:#333333;color:white;">
...
{
    ?>
	    	<div class="accordion-group" style="background-color:#f7f7f7;">
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price" >	
								<span class="price" style="color:#3f445d;">
									Rs. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
									
							    <span class="price-before-discount" style="color:#3f445d;">Rs.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>					
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price" style="color:#3f445d;">Rs. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike" style="color:#3f445d;">Rs.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist" style="background-color:#3f445d;">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary" style="background-color:#3f445d;"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
													<?php } else {?>
							<div class="action" style="color:red">Out of Stock</div>
					<?php } ?>
									</div>
					...
					<div class="row">
						<div class="col-sm-3" >
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell" >
								<li class="active"><a data-toggle="tab" href="#description"style="background-color:#3f445d;">DESCRIPTION</a></li>
								<br><br>
								<li><a data-toggle="tab" href="#review"style="background-color:#3f445d;color: white;">REVIEW</a></li>
			...
			<div class="product-price">	
				<span class="price"style="color:#3f445d;">
					Rs.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount"style="color:#3f445d;">Rs.
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary"style="background-color:#3f445d;">Add to cart</a>

...
?>
				...
				<tr>
					<td class="col-md-2"><img src="admin/productimages/<?php echo htmlentities($row['pid']);?>/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="120" height="100"></td>
					<td class="col-md-6">
...
?>
						...
						<?php } ?>
						<div class="price" style="color:#3f445d;">Rs. 
							<?php echo htmlentities($row['pprice']);?>.00
							<span style="color:#3f445d;">$900.00</span>
						</div>
					</td>
					<td class="col-md-2">
						<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary"style="background-color:#3f445d;">Add to cart</a>
					</td>

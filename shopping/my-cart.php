				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs" style="background-color:#3f445d;">Continue Shopping</a>
								<input type="submit" name="submit" value="Update shopping cart" class="btn btn-upper btn-primary pull-right outer-right-xs"style="background-color:#3f445d;">
							</span>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button" style="background-color:#3f445d;">Update</button>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button"style="background-color:#3f445d;">Update</button>
					<?php } ?>
		...
		<thead>
			<tr>
				<th>
					...
					<div class="cart-grand-total" style="color:#3f445d;">
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary" style="background-color:#3f445d;">PROCEED TO CHEKOUT</button>

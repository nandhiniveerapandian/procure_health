...
?>
	<div class="main-header" style="background-color:#fbea8c;">
		<div class="container">
			<div class="row">
...
<div class="logo" >
	<a href="index.php">
		...
		<h2 style="color:#3f445d;font-weight:bolder;">PROCURE HEALTH</h2>
...
if(!empty($_SESSION['cart'])){
	...
	<div class="dropdown dropdown-cart" >
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown" >
			<div class="items-cart-inner" >
				<div class="total-price-basket" style="background-color:#3f445d;">
	...
	?>
			...
			<div class="clearfix cart-total">
				...
				<a href="my-cart.php" class="btn btn-upper btn-primary btn-block m-t-20"style="background-color:#3f445d;">My Cart</a>	
			</div><!-- /.cart-total-->
...
<div class="dropdown dropdown-cart">
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				<div class="total-price-basket" style="color:#fbea8c;background-color: #3f445d;">
					<span class="lbl">cart -</span>
					<span class="total-price" style="color:#fbea8c">
						<span class="sign">Rs.</span>
